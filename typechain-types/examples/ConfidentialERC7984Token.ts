...
export interface ConfidentialERC7984TokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "allowance"
  ...
  encodeFunctionData(
    functionFragment: "getMyBalanceHandle",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ConfidentialERC7984Token extends BaseContract {
  connect(runner?: ContractRunner | null): ConfidentialERC7984Token;
  waitForDeployment(): Promise<this>;

  interface: ConfidentialERC7984TokenInterface;
  ...
  getMyBalanceHandle: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "getMyBalanceHandle"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
